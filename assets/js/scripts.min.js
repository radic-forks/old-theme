...
$(document).ready(function() {
    var a = $(document.createElement("div"));
    a.attr("id", "github-widget"), a.attr("data-username", "robinradic"), $("body").append(a), 
    ...
    window.Radic.make({}, function(a) {
        a.widget("github-profile", {
            userName: a.options.git.username,
            maxRepos: 3
        });
    });
});